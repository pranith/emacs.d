...
;;;***

;;;### (autoloads nil "helm-plugin" "helm-plugin.el" (0 0 0 0))
;;; Generated autoloads from helm-plugin.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "helm-plugin" '("helm-")))
